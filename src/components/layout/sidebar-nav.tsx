...
import { MdHome, MdAttachMoney, MdSettings, MdLightMode, MdDarkMode, MdLogout, MdSync, MdSearch, MdPerson, MdChevronRight, MdChevronLeft, MdExplore, MdTune, MdHouse, MdLuggage, MdAccountBalance } from 'react-icons/md';
